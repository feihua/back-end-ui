      ...
      render: (_, record) => (
        <>
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/role_update_view")}
            onClick={() => {
          ...
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/query_role_menu_view")}
            onClick={() => {
          ...
          <Button
            ...
            danger
            size="small"
            disabled={!hasPm("/api/role_delete")}
            onClick={() => {
  ...
  return (
    <PageContainer>
      <ProTable<RoleListItem>
        ...
        toolBarRender={() => [
          <Button key={'new'} type="primary" disabled={!hasPm("/api/role_save_view")} onClick={() => handleModalVisible(true)}>
            <PlusOutlined /> 新建角色
          </Button>,
        ]}
        // @ts-ignore
