      ...
      render: (_, record) => (
        <>
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/user_update_view")}
            onClick={() => {
          ...
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/update_user_role_view")}
            onClick={() => {
          ...
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/update_user_password_view")}
            onClick={() => {
          ...
          <Button
            ...
            danger
            size="small"
            disabled={!hasPm("/api/user_delete")}
            onClick={() => {
  ...
  return (
    <PageContainer>
      <ProTable<UserListItem>
        ...
        toolBarRender={() => [
          <Button type="primary" disabled={!hasPm("/api/user_save_view")} onClick={() => handleModalVisible(true)}>
            <PlusOutlined/> 新建用户
          </Button>,
        ]}
        // @ts-ignore
