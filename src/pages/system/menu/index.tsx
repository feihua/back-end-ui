...
const handleAdd = async (fields: MenuListItem) => {
  ...
  try {
    fields.menu_type = Number(fields.menu_type);
    fields.sort = Number(fields.sort);
    fields.status_id = Number(fields.status_id)
      ...
      render: (_, record) => (
        <>
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/menu_update_view")}
            onClick={() => {
          ...
          <Button
            type="primary"
            size="small"
            disabled={!hasPm("/api/menu_save_view")}
            onClick={() => {
          ...
          <Button
            ...
            danger
            size="small"
            disabled={!hasPm("/api/menu_delete")}
            onClick={() => {
  ...
  return (
    <PageContainer>
      <ProTable<MenuListItem>
        ...
        search={false}
        toolBarRender={() => [
          <Button type="primary" disabled={!hasPm("/api/menu_save_view")} onClick={() => handleModalVisible(true)}>
            <PlusOutlined /> 新建菜单
          </Button>,
        ]}
        // @ts-ignore
